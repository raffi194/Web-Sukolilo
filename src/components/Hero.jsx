...
const Hero = ({ addOn, title1, description, children, clip, desktopVideo, mobileVideo, textAlign = "center", justifyContent = "center", className = "" }) => {
  ...
  return (
    <div
      className={`relative min-h-[65vh] sm:min-h-screen w-full overflow-hidden flex items-start justify-${justifyContent} 
  ...
  pb-8 sm:pt-32 sm:pb-32 ${className}`}
    >
      ...
      <div className={`relative z-10 text-${textAlign} text-white right ${addOn ? '' : 'top-10 md:top-20'}`}><motion.div variants={containerVariants} initial="hidden" animate="visible">
        ...
        <motion.h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mt-4 md:mt-6 mx-auto max-w-md md:max-w-2xl" variants={itemVariants}>
          {title1}
        </motion.h1>
