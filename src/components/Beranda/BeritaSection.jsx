  ...
  return (
    <div className="flex flex-col md:flex-row bg-white h-full overflow-hidden shadow-lg rounded-2xl">
      <div className="w-full md:w-2/5 h-56 md:h-full overflow-hidden relative">
        ...
        <motion.img
          src={imageError || !berita.Gambar ? defaultImage : berita.Gambar}
        ...
        >
          {berita["Tipe Berita"] && (
            <motion.span
              ...
              className="bg-blue-600 text-white text-xs font-bold px-3 py-1 rounded-md self-start mb-2"
            >
              {berita["Tipe Berita"]}
            </motion.span>
          )}
          ...
          <motion.h3
            variants={itemVariants}
            className="text-lg md:text-xl xl:text-2xl font-bold mt-1 text-gray-800 leading-tight"
          >
          ...
          <motion.p
            variants={itemVariants}
            className="text-sm mt-3 text-gray-500 flex items-center gap-2"
          >
          ...
          <motion.p
            variants={itemVariants}
            className="text-gray-600 mt-4 text-sm md:text-base line-clamp-3 flex-grow"
          >
          ...
          <motion.button
            variants={itemVariants}
            className="mt-auto pt-4 text-blue-600 font-semibold self-start hover:underline hover:text-blue-700 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded px-1"
            onClick={() => {
              // Add your navigation logic here
              console.log(`Navigate to berita with ID: ${berita.ID}`);
            }}
...
const ErrorState = ({ error, onRetry }) => (
  <div className="flex items-center justify-center py-20">
    <div className="text-center">
      ...
      <p className="text-gray-600 mb-4">Gagal memuat berita: {error}</p>
      <button
        onClick={onRetry}
...
const BeritaSection = () => {
  ...
  return (
    <section className="py-16 md:py-20 bg-gray-50 mx-4 md:mx-10 rounded-2xl">
                ...
                <>
                  ...
                  >
                    <motion.button
                      ...
                      className={`p-3 w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 ${canScrollPrev
                          ? 'bg-blue-600 text-white hover:bg-blue-700'
                          : 'bg-gray-300 text-gray-500 cursor-not-allowed'
                        }`}
                      variants={itemVariants}
                      whileHover={canScrollPrev ? { scale: 1.1, y: -2 } : {}}
                    ...
                    <motion.button
                      ...
                      className={`p-3 w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 ${canScrollNext
                          ? 'bg-blue-600 text-white hover:bg-blue-700'
                          : 'bg-gray-300 text-gray-500 cursor-not-allowed'
                        }`}
                      variants={itemVariants}
                      whileHover={canScrollNext ? { scale: 1.1, y: -2 } : {}}
                  ...
                  <div className="flex justify-center mt-6 gap-2">
                    {beritaData.map((_, index) => (
                      <button
                        ...
                        aria-label={`Pergi ke berita ${index + 1}`}
                      />
                    ))}
                  </div>
                </>
