  ...
  return (
    <div className="py-24 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl font-bold text-gray-800">Layanan Pembuatan Surat</h2>
          <p className="text-gray-500 mt-2">Proses cepat, mudah, dan terintegrasi untuk semua kebutuhan administrasi Anda.</p>
          
          <a 
            href="#" 
            className="mt-6 inline-flex items-center justify-center gap-3 bg-[var(--clr-primary-5)] text-[var(--white)] font-bold py-3 px-8 rounded-full shadow-lg hover:bg-opacity-90 transition-all duration-300 transform hover:scale-105"
          >
            <span>Klik untuk Membuat Surat</span>
           <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center">
                <FontAwesomeIcon icon={faArrowRight} className='text-xl text-[var(--clr-primary-5)]' />
           </div>
          </a>
        </motion.div>
